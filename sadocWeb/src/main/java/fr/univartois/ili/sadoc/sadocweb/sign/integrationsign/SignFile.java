...
public class SignFile {
	...
	private static final String REPERTORY = "/opt/apache-tomcat-6.0.35/certificates/";
	 ...
	 * 
	 * @param Fac's X509 certificate
	 * @param Fac's private key
	 * @param User's keypair
	 * @param User
	...
	public byte[] signDocument(byte[] fileToSign, Owner owner) throws Exception {
		...
		// This store must contain all certificates (CNRS2, CNRS2-Standard, Sadoc and
