...
import fr.univartois.ili.sadoc.metier.ws.services.IMetierWSServicesFindAllAcquisitionByDocument;
...
public class WSPublicImplFindAllAcquisitionByDocument implements WSPublicFindAllAcquisitionByDocument {

	@Autowired
	private IMetierWSServicesFindAllAcquisitionByDocument metierWSServices;
...
//				}
	...
	public List<Acquisition> findAllAcquisition(Document document) {
		return metierWSServices.findAllAcquisition(document);
	}
}
