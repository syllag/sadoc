...
$string['usedoutcomesh_help'] = 'Outcomes used on this server to
evaluate Moodle activities (forums, assignment, data bases, quiz, wiki, etc.)
<br />Skills repository plugin catchs these ouotcomes and display them in the skills repository activities thumb.';

$string['usedoutcomesh_help'] = 'Si les objectifs sont activés sur votre serveur Moodle
...
$string['etablissementh_help'] = 'Help to write on';

$string['etudianth'] = 'Etablissements';
$string['etudianth_help'] = 'Help to write on';
...
$string['referentiel2h'] ='Domain / Competency / Item';
