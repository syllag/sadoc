      ...
      if ($notation){ 
        ...
        if (!empty($notation->userid) && !empty($notation->courseid)){
                    ...
                    if ((empty($users[$notation->userid]->courses[$notation->courseid]->referentiels[$notation->referentiel_instanceid]->module_list))
                            || (!ereg(" $notation->module:$notation->moduleinstance\,", $users[$notation->userid]->courses[$notation->courseid]->referentiels[$notation->referentiel_instanceid]->module_list))){
...
// on verifie si la liste de compétences appartient
// bien au référentiel designé
// histoire d'eviter des affectations intempestives pour des referentiel ayan le même code
/*

object Object
(
    [type_activite] => [Activity Assignment 6]  Date:  Friday,  22 April 2011, 08:03 AM
    [description_activite] => Dépot de fichier avec Objectifs : Déposez un ficheir PDF
