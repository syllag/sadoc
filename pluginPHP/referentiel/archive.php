...
//    require_once('print_lib_certificat.php');	// AFFICHAGES
    ...
    require_once('locallib_portfolio.php');  // export vers portfolio
...
*/
        ...
        if (has_capability('mod/referentiel:export', $context)) {
            ...
            referentiel_select_liste_certificats($referentiel, $list_pedagoids, $userid_filtre, $gusers, $select_acc, $mode, $CFG->wwwroot . '/mod/referentiel/archive.php?d='.$referentiel->id, $select_all, $sql_filtre_where, $data_filtre);
        }
...
// fichiers attachés ?
    echo '<tr><td>'.get_string('export_documents','referentiel', $size_data->nfile).' '. get_string('export_file_size','referentiel', display_size($size_data->size)).' <td>';
if (!$export_documents){
