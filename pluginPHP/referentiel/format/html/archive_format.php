...
if ($seuil_certificat){
            $expout .= " <th class=\"referentiel\">".get_string('seuil_certificat','referentiel')."</th>\n";
}
            ...
            if (!empty($this->records_users)){
                ...
                //exit;
					...
					foreach ($this->records_users as $userid){
                        ...
                        $this->tab_users[$u][1]=strtoupper($lastname).' '.ucfirst($firstname);
                        $u++;
                        
                        $expout .= '<a name="'.$userid.'"></a>'."\n";
                        $expout .= '<p>&nbsp;</p><h3 align="center">'.strtoupper($lastname).' '.ucfirst($firstname).'</h3>'."\n";
