...
<table class='item'>\n";
		if ($document){
            ...
            $expout .= "     <td><b>".get_string('description','referentiel')."</b></td><td> $description_document</td>\n";
            $expout .= "     <td><b>".get_string('url','referentiel')."</b></td><td> $url_document</td>\n";
...
<table class='competence'>\n";
		...
		if ($activite){
            ...
            $expout .= "<td><b>".get_string('description','referentiel')."</b></td><td> $description_activite</td>\n";
            $expout .= "<td><b>".get_string('competences_activite','referentiel')."</b></td><td> $competences_activite</td>\n";
            $expout .= "<td><b>".get_string('commentaire','referentiel')."</b></td><td> $commentaire_activite</td>\n";
            $expout .= "<td><b>".get_string('instance','referentiel')."</b></td><td> $ref_instance</td>\n";
            ...
            $expout .= "<td><b>".get_string('date_creation','referentiel')."</b></td><td>".date("Y-m-d H:i:s",$date_creation)."</td>\n";
            $expout .= "<td><b>".get_string('date_modif','referentiel')."</b></td><td>".date("Y-m-d H:i:s",$date_modif)."</td>\n";
    ...
    function write_referentiel( $referentiel ) {
		...
		if ($referentiel){
            ...
            if ($this->format_condense==1){
                ...
                $expout .= $this->liste_items_competences($referentiel->id)."</tr>\n";
            }
            /*
