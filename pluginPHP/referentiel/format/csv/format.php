...
class rformat_csv extends rformat_default {
	...
	*/
	...
	if (($risque_ecrasement==false) || ($this->newinstance==1)) {
		...
		// DEBUG
		// echo "<br />DEBUG csv/format.php ligne 610<br />\n";
		// print_object($re);
        // exit;
...
class cformat_csv extends cformat_default {
    ...
    function write_referentiel( $referentiel ) {
		...
		if ($referentiel){
            ...
            $description_referentiel = $this->purge_sep($referentiel->description_referentiel);
...
class pformat_csv extends pformat_default {
	...
	***************************************************************************/
	...
	$nbl=count($lines);
	if ($nbl>0){ // premiere ligne entete fichier csv
		// echo "<br>DEBUG :: format/csv/format.php :: 3159 ::<br>$line : ".$lines[$line]."\n";
