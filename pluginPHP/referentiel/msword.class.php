...
class MSWord{
	...
	var $fnt_police='".$this->fnt_police."';
	var $fnt_size=10;
	...
	function SetDiv($page, $div, $ordre, $cadre=1){
		$this->divtop=$page*30+10*$ordre+10;
		$this->style= '
#'.$div.'_'.$page.' {
	position:relative;
	left:10;
...
';  	
	...
	// --------------------------------
	function SetDivPage($page){
		$this->divtop=$page*30+60;
		$this->style= "
#divpage_".$page." {
	position:relative;
	left:680;
...
";
	...
	function SetEntete($titre=''){
		...
		// =====================================================
		// header info
		$type_fichier = 'vnd.msword';
		$nom_fichier = 'certification-'.date("Ymshis").'-'.md5(uniqid()).'.doc';
		$sep = "\t";
		header("Expires: 0");
...
<style>
BODY {
	FONT-SIZE: 10pt; MARGIN: 3px; FONT-FAMILY: ".$this->fnt_police.", Helvetica, sans-serif;  COLOR:#000000; BACKGROUND-COLOR: #ffffff;
}
A {
...
.norm10n {font-family:  ".$this->fnt_police.";  font-size: 10pt; color: #275372;}
.rouge10n {font-family: ".$this->fnt_police."; font-size: 10pt; color: #FF0000;}
.vert10n {font-family: ".$this->fnt_police.";  font-size: 10pt; color: green;}
...
.normal10 {font-family:  ".$this->fnt_police.";  font-size: 10pt;}
