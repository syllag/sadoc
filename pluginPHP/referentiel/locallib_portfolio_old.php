...
class referentiel_portfolio_caller extends portfolio_module_caller_base {
    ...
    global $USER;
        ...
        $entry = new portfolio_format_leap2a_entry('certificat' . $this->certificat->id, $title, 'any', $content); // proposer ability ?
    ...
    private function prepare_certificat() {
        ...
        if (!empty($this->certificat)) {
            $fullname = '';
            $fullnameteacher = get_string('inconnu', 'referentiel');
