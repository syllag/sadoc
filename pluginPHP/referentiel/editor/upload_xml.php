...
// dossier des referentiels enregistres; doit exister sur le serveur
    ...
    require_once("$CFG->wwwroot/mod/referentiel/lib.php");
//    require_once("$CFG->wwwroot/mod/referentiel/import_export_lib.php");	// IMPORT / EXPORT
    require_once("$CFG->libdir/uploadlib.php");


    $ext_xml='.sxml';	// extension du fichier de donnees sauvegardee
    $suffixe='_sxml';   // pour distinguer du format xml basique des sauvegardes du référentiel
    $format='sxml';      // un seul format possible
	...
	elseif ($id) {
		...
		print_error(get_string('erreurscript','referentiel','Erreur01 : editor/upload_xml.php'));
	}
    require_login();
