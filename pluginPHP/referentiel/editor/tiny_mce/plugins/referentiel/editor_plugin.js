                ...
                if (selection){
                    ...
                    if (idcode){
                        ...
                        if (le_reste){
                            ...
                            var le_nom = tinymce.trim(le_reste.substring(0,le_reste.indexOf(" ",0)+1, le_reste.length));
                            if (le_nom){
                                // ed.windowManager.alert("Le nom:"+le_nom);
                                var le_reste = tinymce.trim(le_reste.substring(le_nom.length+1, le_reste.length));
                                //ed.windowManager.alert("Le reste:"+le_reste);
                                var message='NOM_A_VALIDER: ';
                            }
                            ...
                            var str_html  = "[referentiel]<br>\n[idcode]"+idcode+"[/idcode][name]"+message+"[/name]<br>\n[definition][text]<br>\n<br>\n[/text][/definition]<br>\n[/referentiel]<br>\n";
                        }
                    }
                    else{
                        var str_html  = "[referentiel]<br>\n[idcode]<br>\n<br>\n[/idcode][name]"+message+"[/name]<br>\n[definition][text]"+selection+"[/text][/definition]<br>\n<br>\n[/referentiel]<br>\n";
                    }
