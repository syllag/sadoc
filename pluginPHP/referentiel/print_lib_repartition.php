...
/*
                ...
                echo("<br><br>TEACHERS du COURS<br>\n");
...
*/
    ...
    foreach ($t_codes_competence as $code_item){
        if (!empty($instanceid) && !empty($courseid) && !empty($code_item)){
            ...
            // DEBUG
/*
            echo("print_lib_repartition.php :: 47 ::<br>TEACHERS REPARTITION pour la COMPETENCE $code_item<br>\n");
...
*/
            ...
            // DEBUG
/*
            echo("print_lib_repartition.php :: 54 ::<br>TEACHERS INTERSECTION pour la COMPETENCE $code_item<br>\n");
            print_object($teachers_repartition);
            echo("<br>\n");
*/
            for($i=0; $i<count($t_teacherids); $i++){
                if (!empty($t_teacherids_intersect)){
                    // COLLECTER
                    if (in_array($t_teacherids[$i], $t_teacherids_intersect)==true) {
