...
// AFFICHAGE DE LA PAGE Moodle 2
	...
	if (($mode=='scolarite') || ($mode=='listetudiant')){
		referentiel_print_liste_etudiants($mode, $referentiel, $userid_filtre, $gusers); 
	}
	else {
		...
		if ($mode=='updateetudiant'){
			// recuperer l'id du etudiant après l'avoir genere automatiquement et mettre en place les competences
