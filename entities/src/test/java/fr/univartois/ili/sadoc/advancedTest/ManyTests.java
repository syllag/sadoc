...
//		Collections.sort(documents);
		...
		List<Competence> competences1 = SignatureDAO.findCompetenceByDocument(documents.get(0));
		...
		List<Competence> competences2 = SignatureDAO.findCompetenceByDocument(documents.get(1));
		...
		List<Competence> competences3 = SignatureDAO.findCompetenceByDocument(documents.get(2));
		...
		List<Competence> competences4 = SignatureDAO.findCompetenceByDocument(documents.get(3));
		...
		List<Competence> competences5 = SignatureDAO.findCompetenceByDocument(documents.get(4));
		...
		List<Competence> competences6 = SignatureDAO.findCompetenceByDocument(documents.get(5));
		...
		List<Competence> competences7 = SignatureDAO.findCompetenceByDocument(documents.get(6));
		...
		List<Competence> competences8 = SignatureDAO.findCompetenceByDocument(documents.get(7));
